...
Open http://localhost:5173. A scripted virtual-customer timeline replays three shoes being picked up and put back.
...
SEEEDMOTE_BROKER=192.168.1.100 npm run dev

# with auth
SEEEDMOTE_BROKER=192.168.1.100 SEEEDMOTE_BROKER_USER=user SEEEDMOTE_BROKER_PASS=pass npm run dev
```
